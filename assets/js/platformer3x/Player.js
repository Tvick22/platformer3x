...
export class Player extends Character {
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "tube" 
            ...
            || this.collisionData.touchPoints.other.id === "cabin" || this.collisionData.touchPoints.other.id === "toiletEnd") {
        ...
        if (this.collisionData.touchPoints.other.id === "goomba" || this.collisionData.touchPoints.other.id === "flyingGoomba" || this.collisionData.touchPoints.other.id === "Snowman" || this.collisionData.touchPoints.other.id === "Owl" || this.collisionData.touchPoints.other.id === "flyingUFO" || this.collisionData.touchPoints.other.id === "alien" || this.collisionData.touchPoints.other.id === "SkibidiToilet" ) {
